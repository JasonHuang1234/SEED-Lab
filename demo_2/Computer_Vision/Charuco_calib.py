...
if __name__ == '__main__':
    ...
    SQUARE_LENGTH = 0.734375
    MARKER_LENGTH = 0.53125
    CURRENT_PATH = os.path.dirname(os.path.abspath(__file__))

    instaCam = PinholeCalibrator(
        ARUCO_DICT, SQUARES_VERTICALLY, SQUARES_HORIZONTALLY, SQUARE_LENGTH, MARKER_LENGTH, 
        calibration_images_dir= os.path.join(CURRENT_PATH,'./calib_images'),
        raw_images_dir= os.path.join(CURRENT_PATH,'./raw_images')
        )
